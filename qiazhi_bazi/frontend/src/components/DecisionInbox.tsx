      ...
      <div className="space-y-3">
        <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-2">
          <button
            ...
            className="flex w-full items-center justify-between rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 text-left text-xs text-zinc-200 hover:bg-zinc-800"
          >
            <span>冲合裁决清单（Atomic Conflicts Checklist）</span>
            <span>{sectionOpen.checklist ? "收起" : "展开"}</span>
          </button>
          {sectionOpen.checklist ? (
            <AnimatePresence initial={false}>
              <motion.article
                ...
                className="mt-2 rounded-xl border border-zinc-800 bg-zinc-950 p-3"
              >
        ...
        <div className="mt-2 space-y-1">
          ...
          {typeof (structureFinalDecision as { primary_structure?: unknown }).primary_structure === "string" ? (
            <div className="mt-2 rounded-md border border-zinc-700 bg-zinc-900 p-2 text-[11px]">
              ...
              {typeof (structureFinalDecision as { strategic_advice?: { recommendation?: string } }).strategic_advice?.recommendation === "string" ? (
                <div className="mt-2 rounded border border-cyan-500/30 bg-cyan-500/10 p-2 text-cyan-200">
