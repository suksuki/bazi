"""Bind the negation-aware resolution guard to the Mingli agent manifest.

Revision ID: 0047_mingli_resolution_guard
Revises: 0046_mingli_typed_rows
"""
...
revision: str = "0047_mingli_resolution_guard"
down_revision: str | None = "0046_mingli_typed_rows"
                ...
                manifest_json = manifest_json
                    || '{"schema_revision":
                         ...
                         "mingli_agent_adjudication_version":
                             "v60.mingli-agent-adjudication.013",
