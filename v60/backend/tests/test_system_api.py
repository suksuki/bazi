...
def test_manifest_has_no_v50_runtime_dependency() -> None:
    ...
    assert payload["engines"]["mingli"] == "v60.mingli-cognitive-engine.042"
    ...
    assert payload["mingli_agent_runtime"]["runtime_ref"] == ("v60.mingli-agent-runtime.025")
    ...
    assert profile["agent_profile_ref"] == "v60.mingli-agent.whole-chart-cognition.023"
    assert profile["prompt_ref"] == "v60.prompt.mingli-agent-whole-chart.020"
...
def test_health_binds_database_to_runtime_foundation() -> None:
    ...
    assert payload["database"] == {
        "status": "ready",
        "foundation_version": "v60.foundation.031",
        "expected_foundation_version": "v60.foundation.031",
    }
...
def test_database_manifest_binds_current_mingli_agent_contracts() -> None:
    ...
    assert manifest["schema_revision"] == "0039_mingli_suite_contract"
    ...
    assert manifest["mingli_agent_runtime_version"] == "v60.mingli-agent-runtime.025"
