...
export const ADMIN_FEATURE_MODULES: Array<FeatureModule<AdminFeatureTabKey, AdminFeatureContext>> = [
  {
    id: "llm",
    order: 10,
    label: (language) => localized(language, { zh: "模型引擎", en: "Model Engine", ko: "모델 엔진" }),
  ...
  },
  {
    id: "db",
    order: 20,
    label: (language) => localized(language, { zh: "数据库", en: "Database", ko: "데이터베이스" }),
  ...
  },
  {
    id: "plugins",
    order: 30,
    label: (language) => localized(language, { zh: "规则引擎", en: "Rule Engine", ko: "규칙 엔진" }),
  ...
  },
  {
    id: "physics",
    order: 40,
    label: (language) => localized(language, { zh: "参数中心", en: "Parameters", ko: "파라미터" }),
  ...
  },
  {
    id: "evolution",
    order: 50,
    label: (language) => localized(language, { zh: "审计日志", en: "Audit Logs", ko: "감사 로그" }),
  ...
  },
  {
    id: "learning",
    order: 60,
    label: (language) => localized(language, { zh: "学习任务", en: "Learning", ko: "학습 작업" }),
  ...
  },
  {
    id: "users",
    order: 70,
    label: (language) => localized(language, { zh: "成员权限", en: "Members", ko: "멤버 권한" }),
