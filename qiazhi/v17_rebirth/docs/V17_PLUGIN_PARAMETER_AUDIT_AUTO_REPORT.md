...
| classical.pattern.caipoyin.v1 | CAIPOYIN_BREAK_RATIO | 1.08 | pattern_defaults | used_and_configurable | - |
| classical.pattern.caipoyin.v1 | CAIPOYIN_MATCH_BASE | 0.72 | pattern_defaults | used_and_configurable | - |
| classical.pattern.caipoyin.v1 | CAIPOYIN_MIN_SEAL | 16.0 | pattern_defaults | used_and_configurable | - |
| classical.pattern.caipoyin.v1 | CAIPOYIN_MIN_WEALTH | 16.0 | pattern_defaults | used_and_configurable | - |
...
| classical.ziping.climate_bridge.v1 | MATCH_RATIO_MAX | 0.88 | pattern_defaults | used_and_configurable | - |
| classical.ziping.climate_bridge.v1 | MATCH_RATIO_MIN | 0.56 | pattern_defaults | used_and_configurable | - |
...
| classical.ziping.pattern_bridge.v1 | MATCH_RATIO_BASE | 0.58 | pattern_defaults | used_and_configurable | - |
| classical.ziping.pattern_bridge.v1 | MATCH_RATIO_MAX | 0.86 | pattern_defaults | used_and_configurable | - |
| classical.ziping.summary.v1 | MATCH_RATIO_BASE | 0.62 | pattern_defaults | used_and_configurable | - |
| classical.ziping.summary.v1 | MATCH_RATIO_MAX | 0.9 | pattern_defaults | used_and_configurable | - |
...
| l1.physics.op_branch_sanhui | MEETING_GAIN | 1.65 | DECLARED_PARAMS | used_and_configurable | - |
| l1.physics.op_branch_sanhui | MIN_MEETING_STRENGTH | 0.55 | DECLARED_PARAMS | used_and_configurable | - |
| l1.physics.op_branch_sanhui | SOURCE_RETENTION | 0.72 | DECLARED_PARAMS | used_and_configurable | - |
...
| l2.risk.risk_matrix | OFFICER_EXHAUST_RATIO | 2.0 | DECLARED_PARAMS | used_and_configurable | - |
...
| shensha | BRANCH_SHENSHA_MATCH_RATIO | 0.68 | DECLARED_PARAMS | used_and_configurable | - |
| shensha | BRANCH_SHENSHA_MAX_ROWS | 8 | DECLARED_PARAMS | used_and_configurable | - |
| shensha | BRANCH_SHENSHA_PRIORITY | 0.82 | DECLARED_PARAMS | used_and_configurable | - |
...
| ten_god_pattern | AXIS_ORIGIN_SCALE_MIN | 0.92 | DECLARED_PARAMS | used_and_configurable | - |
...
| ten_god_pattern | PROFILE_MIN_SCORE | 10.0 | DECLARED_PARAMS | used_and_configurable | - |
| ten_god_pattern | PROFILE_TOP_GODS | 3 | DECLARED_PARAMS | used_and_configurable | - |
