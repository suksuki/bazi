...
- 十神总分不再视为单一来源，需拆解为显化/根气/势能/潜藏残值
- 三合等强结构在 L0 只给基础结构回灌，不做高层解释

相关协议：

- [V17_TEN_GODS_ENERGY_DECOMPOSITION_PROTOCOL_2026-04-21.md](/Users/liujin/DEV/AIProjects/bazi/qiazhi/v17_rebirth/docs/V17_TEN_GODS_ENERGY_DECOMPOSITION_PROTOCOL_2026-04-21.md)
