...
from v17_rebirth.backend.logic.L2_structure_patterns.classical_evidence import (
    dominant_element_from_ten_gods as _dominant_element,
    element_structure_evidence as _element_structure_evidence,
    gods_for_element as _gods_for_element,
    is_followable_weak_body as _is_followable_weak_body,
    is_self_party_strong as _is_self_party_strong,
    yangren_blade_context as _yangren_blade_context,
    zaqi_evidence as _zaqi_evidence,
)
