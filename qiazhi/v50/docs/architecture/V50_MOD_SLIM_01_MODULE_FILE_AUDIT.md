...
| `scripts/v50_prepare_professional_blind_analyst_calibration.py` | 895 | 4 | Offline evidence packager | No | Keep until evidence retention closes; avoid speculative splitting | Medium | blindness, manifest, SHA and packet reproducibility |
