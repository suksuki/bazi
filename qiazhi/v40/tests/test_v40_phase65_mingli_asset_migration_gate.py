...
def test_phase65_manifest_module_status_and_project_status_track_asset_gate() -> None:
    ...
    assert project_status["current_phase"] == 68
    assert project_status["current_phase_name"] == "Knowledge Portrait Ziwei Sidecar Enrichment"
    ...
    assert project_status["next_mainline_tasks"][0] == "P68-1: Knowledge / Portrait / Ziwei sidecar enrichment"
