...
def test_phase65_manifest_module_status_and_project_status_track_asset_gate() -> None:
    ...
    assert project_status["current_phase"] == 69
    assert project_status["current_phase_name"] == "Real Case Expansion And Cutover Evidence"
    ...
    assert project_status["next_mainline_tasks"][0] == "P69-1: real case expansion and online cutover evidence"
