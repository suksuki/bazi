...
def build_product_projection(
    *,
    ...
    product_verdict_cards: list[ProductVerdictCard] = []
    for verdict in verdicts:
        product_verdict_cards.append(
            ProductVerdictCard(
                ...
                role_visibility=["guest", "user", "practitioner"] if role_key in {"guest", "user"} else [role_key],
            )
        )
    product_advice_cards: list[ProductAdviceCard] = []
    for advice in advice_plans:
        product_advice_cards.append(
            ProductAdviceCard(
