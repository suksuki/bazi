...
def _default_label_contract() -> Dict[str, Any]:
    return {
        ...
        "terms": {
            ...
            "does_not_represent_prediction": {"category": "oracle_ui", "label": {"zh": "这不代表预测。", "en": "This does not represent prediction.", "ko": "이것은 예측을 의미하지 않습니다."}, "description": {"zh": "防误解提示。", "en": "Anti-misinterpretation notice.", "ko": "오해 방지 안내입니다."}},
            ...
            "q_result_card_boundary": {"category": "oracle_question", "label": {"zh": "为什么 ResultCard 不是传统断语？", "en": "Why is the ResultCard not traditional fortune text?", "ko": "왜 ResultCard는 전통식 단정문이 아닌가요?"}, "description": {"zh": "边界问题。", "en": "Boundary question.", "ko": "경계 질문입니다."}},
            ...
            "income_stability_result": {"category": "oracle_ui", "label": {"zh": "收入稳定性结果", "en": "Income stability result", "ko": "소득 안정성 결과"}, "description": {"zh": "结果卡标题。", "en": "Result card heading.", "ko": "결과 카드 제목입니다."}},
            ...
            "evidence_summary": {"category": "oracle_ui", "label": {"zh": "这里仅展示结构摘要；详细 rule_id 仅在 Lab 中显示。", "en": "Only structure summaries are shown here; detailed rule_id appears in Lab only.", "ko": "여기에는 구조 요약만 표시되며 자세한 rule_id는 Lab에서만 표시됩니다."}, "description": {"zh": "用户端证据说明。", "en": "User evidence summary.", "ko": "사용자 근거 요약입니다."}},
            "source_summary": {"category": "oracle_ui", "label": {"zh": "结构输入 + 确定性规则", "en": "Structure input + deterministic rule", "ko": "구조 입력 + 결정론적 규칙"}, "description": {"zh": "用户端证据来源。", "en": "User-facing source summary.", "ko": "사용자용 근거 출처입니다."}},
            ...
            "deterministic": {"category": "oracle_badge", "label": {"zh": "确定性规则", "en": "Deterministic", "ko": "결정론적 규칙"}, "description": {"zh": "非 LLM 主结论。", "en": "Not an LLM primary result.", "ko": "LLM 주 결론이 아닙니다."}},
            "not_fortune": {"category": "oracle_badge", "label": {"zh": "不是财运预测", "en": "Not fortune prediction", "ko": "재물운 예측 아님"}, "description": {"zh": "边界。", "en": "Boundary.", "ko": "경계입니다."}},
            ...
            "not_prediction": {"category": "oracle_badge", "label": {"zh": "不是预测", "en": "Not prediction", "ko": "예측 아님"}, "description": {"zh": "边界。", "en": "Boundary.", "ko": "경계입니다."}},
            ...
            "income_stability": {
                ...
                "description": {"zh": "财富域结构信号，不是财富预测。", "en": "A wealth-domain structure signal, not a wealth prediction.", "ko": "재물 영역의 구조 신호이며 예측이 아닙니다."},
            },
            "time_structure": {
                "category": "boundary",
                "label": {"zh": "时间结构", "en": "Time Structure", "ko": "시간 구조"},
                "description": {"zh": "上下文，不是预测。", "en": "Context only, not prediction.", "ko": "맥락일 뿐 예측이 아닙니다."},
            },
