...
def build_rule_replay_eval_report(
    ...
    *,
    ...
    registry = build_decision_registry_iteration_report(domain, limit=limit, per_rule=per_rule, progress=progress)
...
def write_rule_replay_eval_artifact(
    *,
    ...
    report = build_rule_replay_eval_report(domain, limit=limit, per_rule=per_rule, progress=progress)
