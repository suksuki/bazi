...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V30 Bazi LLM context and prompt readiness checks.")
    parser.add_argument("--reading-id", default="bl1-bl3-bazi-llm-context-prompt")
    parser.add_argument("--json", action="store_true")
    args = parser.parse_args()

    result = run_bazi_llm_context_prompt_readiness(reading_id=args.reading_id)
