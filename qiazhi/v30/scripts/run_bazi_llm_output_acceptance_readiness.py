...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V30 Bazi LLM output acceptance readiness checks.")
    parser.add_argument("--reading-id", default="bl5-bazi-llm-output-acceptance")
    parser.add_argument("--json", action="store_true")
    args = parser.parse_args()

    result = run_bazi_llm_output_acceptance_readiness(reading_id=args.reading_id)
