...
from v30.validation import run_synthetic_typical_answer_calibration_closeout


def main() -> int:
    parser = argparse.ArgumentParser(description="Run CORE-CAL-S3 typical Bazi answer calibration closeout.")
    ...
    if args.json:
        ...
        print(
            f"{result['version']}: "
            f"{'passed' if decision['synthetic_typical_answer_calibration_closed'] else 'blocked'} "
    ...
    return 0 if decision["synthetic_typical_answer_calibration_closed"] else 1
