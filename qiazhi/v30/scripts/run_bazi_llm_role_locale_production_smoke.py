...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run V30 Bazi LLM role and locale production smoke.")
    parser.add_argument("--reading-id", default="bl7-bazi-llm-role-locale-smoke")
    parser.add_argument("--json", action="store_true")
    args = parser.parse_args()

    result = run_bazi_llm_role_locale_production_smoke(reading_id=args.reading_id)
