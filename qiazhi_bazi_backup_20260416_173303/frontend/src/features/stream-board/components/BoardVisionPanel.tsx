...
import { PatternWaterlinePanel } from "./PatternWaterlinePanel";
...
export function BoardVisionPanel({
  ...
  return (
    ...
    >
      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-2">
        <PatternWaterlinePanel
          committed={patternThresholds || []}
          preview={labState.previewPatternThresholds || null}
          shadowActive={Boolean(labState.previewStructuralLinkActive)}
