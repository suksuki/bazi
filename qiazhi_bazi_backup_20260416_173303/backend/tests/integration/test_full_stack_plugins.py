...
def test_pattern_sovereignty_reconciles_robber_wealth_alloc() -> None:
    ...
    async def _body() -> None:
        ...
        assert isinstance(pp1.get("sovereignty_priority"), bool)
        assert str(pp1.get("pattern_kind") or "") in {"hua_candidate", "cong_fire"} or str(pp1.get("pattern_kind") or "").startswith("cong_")
